...
export default {
  ...
  methods: {
    ...
    setErrors: function(){
      ...
      if(!this.fields.pro_needs && !this.fields.late_needs && !this.fields.all_needs){
        this.errors.needs = '必要数量を入力してください.';
      }
      if(this.fields.selectGrade === "" && this.fields.selectThema !== ""){
        this.errors.grade_thema = '学年学科を選択してください.';
      }else if(this.fields.selectGrade !== "" && this.fields.selectThema === ""){
