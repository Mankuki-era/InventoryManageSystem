...
if($mode == 'GET'){
  ...
  if($func == 'index'){
    ...
    if($_GET['keyword'] != ''){
      ...
      $keyword = "%$keyword%";
      $sql = "SELECT * FROM Items WHERE (name LIKE :indexType OR category LIKE :indexType) AND (name LIKE :keyword OR category LIKE :keyword) ORDER BY favorite DESC";
    }else{
      $sql = "SELECT * FROM Items WHERE name LIKE :indexType OR category LIKE :indexType ORDER BY favorite DESC";
    }
  }elseif($func == 'show'){
  ...
  if($func == 'index'){
    $stmt->bindValue(':indexType', $indexType);
    if($_GET['keyword'] != '') $stmt->bindValue(':keyword', $keyword);
  };
